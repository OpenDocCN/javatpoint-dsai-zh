...
> 原文:[https://www.javatpoint.com/training-of-rnn-in-tensorflow](https://www.javatpoint.com/training-of-rnn-in-tensorflow)

递归神经网络是一种面向深度学习的算法，它遵循顺序方法。在神经网络中，我们假设所有层的每个输入和输出都是独立的。这些类型的神经网络被称为**递归**，因为它们依次执行数学计算。

![Training of RNN in TensorFlow](../Images/b4e36a77b01c8ec6120b748bac777dfd.png)
...
![Training of RNN in TensorFlow](../Images/3d984bc1e059335357f7f7aaef8aa934.png)
